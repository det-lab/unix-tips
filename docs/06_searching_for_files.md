...
Now that we have a better handle on searching for specific files, [click here to continue on to the next section](07_searching_inside_files.md) to learn how to search for specific text inside of your files.